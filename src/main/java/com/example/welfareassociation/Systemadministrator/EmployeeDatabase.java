...
public class EmployeeDatabase
{
    ...
    private void refreshTable(){
        employeeTableView.setItems(com.example.welfareassociation.model.EmployeeDatabase.getEmployeeList());
    }
    ...
    public void searchButtonOA(ActionEvent actionEvent) {
        ...
        employeeTableView.setItems(com.example.welfareassociation.model.EmployeeDatabase.searchEmployee(keyword));
    ...
    public void updateButtonOA(ActionEvent actionEvent) {
        ...
        com.example.welfareassociation.model.EmployeeDatabase.updateEmployee(
                selectedEmployee,
                name,
                department,
                phone,
